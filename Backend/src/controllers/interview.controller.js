    ...
    try {
        ...
        if (req.file) {
            try {
                ...
                resumeContent = textResult.text || ""
            } catch (pdfErr) {
                console.error("PDF parse error, fallback to string conversion:", pdfErr.message)
        ...
        if (!jobDescription || (!resumeContent && !selfDescription)) {

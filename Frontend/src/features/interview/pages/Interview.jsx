...
const NAV_ITEMS = [
    ...
    { id: 'roadmap', label: 'Prep Roadmap', icon: (<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polygon points="3 11 22 2 13 21 11 13 3 11" /></svg>) },
]
...
const Interview = () => {
    ...
    const scoreLabel =
        report.matchScore >= 80 ? 'Excellent Match! 🚀' :
            report.matchScore >= 60 ? 'Good Fit 👍' : 'Needs Work 📚'
            ...
            <div className='interview-outer'>
                ...
                <div className='interview-page-header'>
                    ...
                    <div className='page-header-info'>
                        ...
                        <span className='page-header-date'>Generated on {new Date(report.createdAt).toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}</span>
                    </div>
                    <button
                ...
                <div className='interview-layout'>
                    ...
                    <nav className='interview-nav'>
                        ...
                        {/* Score in Nav */}
                        <div className={`nav-score ${scoreColor}`}>
                            <span className='nav-score__value'>{report.matchScore}%</span>
                            <span className='nav-score__label'>Match</span>
                        </div>
                    </nav>
                    ...
                    <aside className='interview-sidebar'>
                        ...
                        <div className='sidebar-stats'>
                            <p className='skill-gaps__label'>Stats</p>
                            <div className='stat-item'>
                                ...
                                <span>{report.technicalQuestions.length} Technical Qs</span>
                            </div>
                            <div className='stat-item'>
                                ...
                                <span>{report.behavioralQuestions.length} Behavioral Qs</span>
                            </div>
                            <div className='stat-item'>
